...
krusty_the_clown.connect_to(troy_mcclure, "is a fan of")
    .connect_to(troy_mcclure, "is friends with")

lisa_simpson.connect_to(springfield_elementary, "attends")
...
nelson_muntz.connect_to(springfield_elementary, "attends")
    connect_to(krusty_the_clown, "is a fan of")

otto_mann.connect_to(springfield_elementary, "works at")
